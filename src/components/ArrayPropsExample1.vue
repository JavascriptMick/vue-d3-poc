...
const AppProps = Vue.extend({
  props: {
   propTest1: {type: String, default: () => 'Default Prop'},
   propTest2: {type: Array, default: () => ['D', 'e', 'f', 'a', 'u', 'l', 't']}
  },
});

@Component({})
export default class ArrayPropsExample1 extends AppProps {
  test1: string;
  test2: string[];
